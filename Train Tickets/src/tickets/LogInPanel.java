...
public class LogInPanel extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       try{
        ...
        //here below, we check wether passwords and mail is in database or not
        PreparedStatement stmt = conn.prepareStatement("select * from tbl_sign_up_info");
        ResultSet res = stmt.executeQuery();
        while(res.next()){
        String database_mail = res.getString(5);
        String database_password = res.getString(6);
            if( (mail.equals(database_mail)) &&(password.equals(database_password))){
            this.dispose();
        
            //new HomePanel().passUserNumber(mail);
           // new HomePanel().jLabel3.setText("oko");
           new HomePanel(mail).setVisible(true);
           //new HomePanel().setVisible(true);
            }
            else{
                jLabel6.setText("Wrong Credentials inserted!!!");
                //this.dispose();
    ...
    static private LogInPanel PageLogin;
}
